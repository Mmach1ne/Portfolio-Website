...
export function AudiologVisual() {
  ...
  return (
    <WindowChrome title="AUDILOG Dashboard">
      <Box ref={ref} sx={{ display: 'grid', gap: 1.5 }}>
        <WaveformCanvas running={running} reducedMotion={reducedMotion} seed={55} />
        ...
        >
          <Text
            ...
            sx={{
              ...
              whiteSpace: 'nowrap',
              animation: reducedMotion || !running ? 'none' : 'audiolog-ticker 8s linear infinite',
